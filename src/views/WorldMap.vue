...
import { getWorldStats } from '@/api/monitor';
...
const registerMap = async () => {
  try {
    // Using a CDN for the world map GeoJSON
    const { data } = await axios.get('https://cdn.jsdelivr.net/npm/echarts@4.9.0/map/json/world.json');
